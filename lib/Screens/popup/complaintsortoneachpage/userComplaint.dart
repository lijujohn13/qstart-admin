...
//to display complaints according to complaint posted user - popup on click on user table view

Future userComplaint(
    BuildContext ctx, int count, String username, var userid) async {
  print('working');
              ...
              (count == 0)
                  ? Column(
                      children: [
                        ...
                        Text(
                          username + 'haven\'t posted any Complaints',
                          style: GoogleFonts.poppins(
